...
const TemplateSelectionModal = ({
  ...
  return (
    ...
    >
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto dark:bg-[#121212]">
        {step === "select" ? (
          <>
            <DialogHeader>
                  ...
                  {filteredTemplates.length > 0 ? (
                    filteredTemplates.map((template) => (
                      <div
                        ...
                        role="button"
                        tabIndex={0}
                        className={`relative border flex rounded-lg p-4 cursor-pointer transition-all duration-300 hover:scale-102 ${
                          selectedTemplate === template.id
                            ? "border-[#E93F3F] bg-red-50 dark:bg-[#2a1b1b]"
                            : "bg-white dark:bg-[#1f1f1f] hover:border-[#E93F3F] shadow-md"
                        }`}
